...
<form action="/products/edit/${product.id}" method="post">
    <table class="table table-striped">
        ...
        <tr>
            <td>Name</td>
            <td><input type="text" name="name" value="${product.name}" size="100"></td>
        </tr>
        <tr>
            <td>Price</td>
        ...
        <tr>
            <td>Avatar</td>
            <td><input type="text" name="img" value="${product.image}" size="100"></td>
        </tr>
        <tr>
            <td></td>
            <td><input class="btn btn-primary" type="submit" value="Edit" size="100"></td>
        </tr>
